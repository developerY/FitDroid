...
import com.ylabz.fit.fitdroid.common.logger.Log;
import com.ylabz.fit.fitdroid.common.logger.LogView;
import com.ylabz.fit.fitdroid.common.logger.LogWrapper;
import com.ylabz.fit.fitdroid.common.logger.MessageOnlyLogFilter;
...
public class MainFitActivity extends AppCompatActivity {

    private GoogleApiClient mClient = null;
    public static final String TAG = "FitDroid";
     ...
     */
    private void buildFitnessClientLocation() {
                    ...
                    .enableAutoManage(this, 0, new GoogleApiClient.OnConnectionFailedListener() {
                        ...
                        public void onConnectionFailed(ConnectionResult result) {
                            Log.i(TAG, "Google Play services connection failed. Cause: " +
                                    result.toString());
                            Snackbar.make(
                                    MainFitActivity.this.findViewById(R.id.main_activity_view),
     ...
     */
    private void buildFitnessClientSteps() {
            ...
            Snackbar.make(
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(MainFitActivity.this,
            ...
            public void run() {
                ...
                for(Node node : nodes.getNodes()) {
                    MessageApi.SendMessageResult result = Wearable.MessageApi.sendMessage(
                            mClient, node.getId(), path, text.getBytes() ).await();
                }
